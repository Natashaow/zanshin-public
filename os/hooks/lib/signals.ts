...
export const SIGNALS: readonly Signal[] = [
	{
		name: "DECISION",
		message:
			"DECISION detected — consider creating a Decision Record in 02 - Active Projects/ and logging in work/Index.md Decisions Log",
		subHint: {
			message:
	...
	},
	{
		name: "PROJECT UPDATE",
		message:
			"PROJECT UPDATE detected — consider updating the active work note in 02 - Active Projects/ and checking if wins should go to brag doc",
		patterns: [
			// English
			"project update",
			"sprint",
